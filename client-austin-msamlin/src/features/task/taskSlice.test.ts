...
describe('task reducer', () => {
  ...
  it('should handle addTasks action', () => {
    const tasks: Task[] = [
      { id: 1, message: 'Task 1', sortOrder: 0 },
      { id: 2, message: 'Task 2', sortOrder: 1 },
    ];
  ...
  it('should handle addTask action', () => {
    ...
    expect(currentState).toEqual([
      { id: 0, message: 'New Task', sortOrder: 0 },
    ]);
  });
  ...
  it('should handle editTask action', () => {
    ...
    expect(
      taskReducer(
        startingState,
        editTask({ id: 1, message: 'Updated Task 1' }),
      ),
  ...
  it('should handle updateSort action', () => {
    ...
    expect(taskReducer(startingState, updateSort(updatedTasks))).toEqual(
      updatedTasks,
    );
  });
});
